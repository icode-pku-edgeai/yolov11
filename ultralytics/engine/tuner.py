...
class Tuner:
    ...
    def _mutate(self, parent="single", n=5, mutation=0.8, sigma=0.2):
        ...
        """
        if self.tune_csv.exists():  # if CSV file exists: select best hyps and mutate #要么从最优csv文件中加载，要么从space加载
            # Select parent(s)
    ...
    def __call__(self, model=None, iterations=10, cleanup=True):
        ...
        for i in range(iterations):
            ...
            try:
                # Train YOLO model with mutated hyperparameters (run in subprocess to avoid dataloader hang)使用变异超参训练
            ...
            # Save results and mutated_hyp to CSV存结果
            ...
            # Plot tune results 绘图
            plot_tune_results(self.tune_csv)

            # Save and print tune results 保存
            header = (
