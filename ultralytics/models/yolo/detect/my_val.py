...
if __name__ == '__main__':
    # 加载模型
    model = YOLO(r'C:\\Users\\li\\Desktop\\tl\\实验结果\\origin\\yolov11l_origin\\best.pt')  
    # 验证模型
    metrics=model.val(
        val=True,  # (bool) 在训练期间进行验证/测试
        data=r'C:\\Users\\li\\Desktop\\repo\\detection\\yolo\\yolov11\\ultralytics\\models\\yolo\\detect\\tl.yaml',
