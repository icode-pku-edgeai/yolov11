...
class MaskDecoder(nn.Module):
    ...
    生成掩码及其相关质量评分的解码器模块,采用transformer架构。
    ...
    def predict_masks(
        ...
        #通过transformer架构使用图像和提示嵌入预测掩码和质量分数。
...
class SAM2MaskDecoder(nn.Module):
    ...
    “基于Transformer的解码器,用于从图像和提示嵌入预测实例分割掩码。”
